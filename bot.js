...
async function performLoginSequence() {
    ...
    try {
        ...
        await fastBuild9x9WithCenterHole();  // await ekle, async
...
async function fastBuild9x9WithCenterHole() {
    ...
    while (Date.now() - startTime < timeoutMs) {
        // Envanterden blok seç (farmland öncelikli, ama item adı 'farmland' olmayabilir – sunucu modluysa 'farmland')
        ...
        console.log(`[build] Kullanılan: \( {placeable.name} ( \){placeable.count})`);  // template literal düzeltildi
