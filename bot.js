...
/* ══════════════════════════════════════════════════════
   ARAMA VE ANALİZ (Edward Elric Temalı)
   ══════════════════════════════════════════════════════ */
...
client.on('messageCreate', async msg => {
  ...
  if (msg.content.toLowerCase() === 'eguard') {
    ...
    return msg.reply('✅ **Edward Guard Aktif!** Limitler: 12 saatte 2 işlem.');
  }
...
client.once('ready', () => console.log(`✅ Edward Elric Göreve Hazır!`));
